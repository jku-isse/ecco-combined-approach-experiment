...
CSV_PATH = r'/home/user/results/significance/replication_significance_results.csv'
OUTPUT_PATH = r'/home/user/results/significance/replication_significance_results_filtered.csv'
